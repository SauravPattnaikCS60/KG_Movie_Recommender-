...
st.set_page_config(page_title="Recommendation System", page_icon=":memo:", layout="wide")

# Add a title text with white color and center align
st.write(
    f'<h1 style="color: white; text-align: center;">Movie Recommender</h1>',
...
recommendation_model = joblib.load(open('data/recommendation_model.pkl','rb'))
